...
// exit;
        ...
        <article class='wrpProduct wrpProduct-<?php echo esc_attr( $ID ); ?>'>
            <?php echo self::productImage( $product, $attributes ); ?>
            
            <div class='wrpProductDetails'>
                <?php
                    echo self::productTitle( $product, $attributes );
                    echo self::productRating( $product, $attributes );
                    echo self::productPrice( $product, $attributes );
                    echo self::productAddToCartArea( $product, $attributes );
                ?>
            </div>

            <?php echo self::productOnSale( $product, $attributes ); ?>
        </article>
